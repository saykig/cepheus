...
const annual = {
  title: 'Institutional Capacity Explorer',
  description: 'Which institutions actually hold the knowledge and the authority for a given field, and how that has shifted over time.',
...
const gap = {
  title: 'Gap Map',
  description: 'Each field placed by where its institutional weakness lies. Distance from the diagonal is the gap between capacity and control.',
...
const relationships = {
  ...
  description: 'Fields and institutions as one map. Lines show what each institution knows, what it controls, what it depends on, and how the two connect.',
