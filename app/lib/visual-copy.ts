...
export const visualCopy: Record<Locale, VisualCopy> = {
  en: {
    ...
    about: 'About this tool', chooseAxes: 'Choose axes', importance: 'Importance', circleImportance: 'Circle size = importance', inBalance: 'in balance',
  ...
  ru: {
    ...
    about: 'Об инструменте', chooseAxes: 'Выберите оси', importance: 'Значимость', circleImportance: 'Размер круга = значимость', inBalance: 'равновесие',
  ...
  ko: {
    ...
    about: '도구 소개', chooseAxes: '축 선택', importance: '중요도', circleImportance: '원 크기 = 중요도', inBalance: '균형',
  ...
  fr: {
    ...
    about: 'À propos', chooseAxes: 'Choisir les axes', importance: 'Importance', circleImportance: 'Taille du cercle = importance', inBalance: 'à l’équilibre',
  ...
  'zh-CN': {
    ...
    about: '关于此工具', chooseAxes: '选择坐标轴', importance: '重要性', circleImportance: '圆圈大小 = 重要性', inBalance: '平衡',
